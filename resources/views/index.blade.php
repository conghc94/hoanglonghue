...
<nav id="menu" class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.html"><i class="fa fa-sun-o"></i>Hoàng Long<strong></strong></a> </div>

        <!-- Collect the nav links, forms, and other content for toggling -->
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                <li><a href="#home" class="page-scroll">TRANG CHỦ</a></li>
                <li><a href="#services-section" class="page-scroll">DỊCH VỤ</a></li>
                <li><a href="#works-section" class="page-scroll">DANH MỤC</a></li>
                <li><a href="#about-section" class="page-scroll">VỀ CHÚNG TÔI</a></li>
                <li><a href="#team-section" class="page-scroll">Team</a></li>
                <li><a href="#contact-section" class="page-scroll">LIÊN HỆ</a></li>
            </ul>
        </div>
        <!-- /.navbar-collapse -->
    </div>
...
<header class="text-center" name="home">
    <div class="intro-text">
        <h1><strong>HOÀNG LONG</strong></h1>
        <p>Công ty Cổ Phần Đầu tư Xây dựng và Cung ứng Nhân lực Hoàng Long</p>
        <a href="#services-section" class="btn btn-default btn-lg page-scroll">TÌM HIỂU THÊM</a> </div>
</header>
            ...
            <div class="portfolio-items">
                <div class="col-sm-6 col-md-3 col-lg-3 web">
                    <div class="portfolio-item">
                        <div class="hover-bg"> <a href="{{ asset('img/portfolio/01.jpg') }}" rel="prettyPhoto">
                                <div class="hover-text">
                                    <h4>Project Title</h4>
                                    <small>Web Design</small>
                                    <div class="clearfix"></div>
                                </div>
                                <img src="{{ asset('img/portfolio/01.jpg') }}" class="img-responsive" alt="Project Title"> </a> </div>
                    </div>
                </div>
                <div class="col-sm-6 col-md-3 col-lg-3 app">
                    <div class="portfolio-item">
                        <div class="hover-bg"> <a href="{{ asset('img/portfolio/02.jpg') }}" rel="prettyPhoto">
                                <div class="hover-text">
                                    <h4>Project Title</h4>
                ...
                <div class="col-sm-6 col-md-3 col-lg-3 web">
                    <div class="portfolio-item">
                        <div class="hover-bg"> <a href="{{ asset('img/portfolio/03.jpg') }}" rel="prettyPhoto">
                                <div class="hover-text">
                                    <h4>Project Title</h4>
                                    <small>Web Design</small>
                                    <div class="clearfix"></div>
                ...
                <div class="col-sm-6 col-md-3 col-lg-3 web">
                    <div class="portfolio-item">
                        <div class="hover-bg"> <a href="{{ asset('img/portfolio/04.jpg') }}" rel="prettyPhoto">
                                <div class="hover-text">
                                    <h4>Project Title</h4>
                                    <small>Web Design</small>
                                    <div class="clearfix"></div>
                ...
                <div class="col-sm-6 col-md-3 col-lg-3 app">
                    <div class="portfolio-item">
                        <div class="hover-bg"> <a href="{{ asset('img/portfolio/05.jpg') }}" rel="prettyPhoto">
                                <div class="hover-text">
                                    <h4>Project Title</h4>
                                    <small>App Development</small>
                                    <div class="clearfix"></div>
                ...
                <div class="col-sm-6 col-md-3 col-lg-3 branding">
                    <div class="portfolio-item">
                        <div class="hover-bg"> <a href="{{ asset('img/portfolio/06.jpg') }}" rel="prettyPhoto">
                                <div class="hover-text">
                                    <h4>Project Title</h4>
                ...
                <div class="col-sm-6 col-md-3 col-lg-3 branding app">
                    <div class="portfolio-item">
                        <div class="hover-bg"> <a href="{{ asset('img/portfolio/07.jpg') }}" rel="prettyPhoto">
                                <div class="hover-text">
                                    <h4>Project Title</h4>
                ...
                <div class="col-sm-6 col-md-3 col-lg-3 web">
                    <div class="portfolio-item">
                        <div class="hover-bg"> <a href="{{ asset('img/portfolio/08.jpg') }}" rel="prettyPhoto">
                                <div class="hover-text">
                                    <h4>Project Title</h4>
                                    <small>Web Design</small>
                                    <div class="clearfix"></div>
...
<div id="about-section">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6"> <img src="{{ asset('img/about.jpg') }}" class="img-responsive"> </div>
            <div class="col-md-6">
    ...
    <div class="container">
        ...
        <div id="row">
            <div class="col-md-3 col-sm-6 team">
                <div class="thumbnail"> <img src="{{ asset('img/team/01.jpg') }}" alt="..." class="img-circle team-img">
                    <div class="caption">
                        <h3>John Doe</h3>
                        <p>Founder / CEO</p>
            ...
            <div class="col-md-3 col-sm-6 team">
                <div class="thumbnail"> <img src="{{ asset('img/team/02.jpg') }}" alt="..." class="img-circle team-img">
                    <div class="caption">
                        <h3>Mike Doe</h3>
                        <p>Web Designer</p>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
            ...
            <div class="col-md-3 col-sm-6 team">
                <div class="thumbnail"> <img src="{{ asset('img/team/03.jpg') }}" alt="..." class="img-circle team-img">
                    <div class="caption">
                        <h3>Jane Doe</h3>
            ...
            <div class="col-md-3 col-sm-6 team">
                <div class="thumbnail"> <img src="{{ asset('img/team/04.jpg') }}" alt="..." class="img-circle team-img">
                    <div class="caption">
                        <h3>Larry Show</h3>
                        <p>Project Manager</p>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
...
<script type="text/javascript" src="{{URL::asset('js/waypoints.js')}}"></script>
